...
public class CargaInformacion {
    ...
    private void iniciarNodos() {
        ...
        nodos.add(new Nodo(4,"Zona 3",   "CC:1E:66:4C:E6:93"));      // 0  Be03
        nodos.add(new Nodo(5,"entrada 3",    "CC:1E:66:4C:E6:93"));      // 0  Be03
/*
...
*/
    ...
    private void iniciaZonas(){
        ...
        zonas.add(new BeaconZona("CC:1E:66:4C:E6:93",4,"Zona 3"));//Be03
    }
